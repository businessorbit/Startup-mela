...
const EventNavbar = () => {
  ...
  return (
    <div >
      ...
      {/* Main Content - to show the navbar properly */}
          ...
          <div className="text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl md:text-2xl text-purple-300 font-light">
                Welcome to College Events Management
              </p>
            </div>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-full shadow-lg hover:shadow-purple-500/25 transform hover:scale-105 transition-all duration-300">
                Explore Events
              </button>
              <button className="px-8 py-4 border border-purple-500 text-purple-300 hover:text-white hover:bg-purple-600/20 font-semibold rounded-full transition-all duration-300">
                Learn More
              </button>
            </div>
          </div>
