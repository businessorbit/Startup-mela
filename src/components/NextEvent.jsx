...
//                   <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-gray-900 leading-tight text-left"
//                     style={{ fontFamily: "Century Gothic, AppleGothic, sans-serif" }}>
//                     All You Need to Know About
//                   </h1>
//                   <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[3.2rem] font-semibold text-gray-900 leading-tight mt-4 mb-5 text-left"
//                     style={{ fontFamily: "Century Gothic, AppleGothic, sans-serif" }}>
//                     Chandigarh's
//                   </h1>
//                   <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[3.2rem] font-semibold text-gray-900 leading-tight mt-5 text-left"
//                     style={{ fontFamily: "Century Gothic, AppleGothic, sans-serif" }}>
//                     Biggest Startup Event
//                   </h1>
//                 </div>
...
//                 <div className="text-right max-w-xl flex-shrink-0">
//                   <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed mb-0">
//                     This section provides all the information for anyone who is
//                   </p>
//                   <p className="text-base sm:text-lg lg:text-xl text-gray-600 mt-0">
